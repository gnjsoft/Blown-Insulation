        ...
        <>
            ...
            <section className='lg:max-w-[1320px] md:max-w-full mx-auto py-10 px-3'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-4 my-10'>
                    ...
                    <div className='mb-10'>
                        <img src='blownimage/hot.jpg' className='w-100 h-70 bg-cover' />
                    ...
                    <div className='mb-10'>
                        <img src='blownimage/cold.jpg' className='w-100 h-70 bg-cover' />
                    ...
                    <div className='mb-10'>
                        <img src='blownimage/hot1.jpg' className='w-100 h-70 bg-cover' />
                    ...
                    <div className='mb-10'>
                        <img src='blownimage/jacketing.webp' className='w-100 h-70 bg-cover' />
                    ...
                    <div className='mb-10'>
                        <img src='blownimage/fireproof.jpg' className='w-100 h-70 bg-cover' />
                    ...
                    <div className='mb-10'>
                        <img src='blownimage/manpower.jpg' className='w-100 h-70 bg-cover' />
                        <h2 className='text-center text-[#00a0d7] text-xl py-5 font-[tenor-sans]'>Man Power Supply</h2>
