    ...
    return (
        <>
            <section className='lg:max-w-[1320px] md:max-w-full mx-auto py-10'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-15 py-10 p-3'>
                    <div>
                        <h1 className='font-[tenor-sans] text-3xl pb-4'>BLOWN INSULATION SERVICES</h1>
                        <p className='text-gray-500 font-[tenor-sans] text-[17px] text-justify'> Blown Insulation Services Pvt. Ltd. specializes in high-quality thermal insulation, fireproofing, and
